...
<div class="auth-card">
    ...
    <form method="POST" action="<?php echo e(route('register.submit')); ?>" id="regForm">
        <?php echo csrf_field(); ?>
        ...
        <div id="rs3" style="display:none;">
            ...
            <div style="display:flex;align-items:flex-start;gap:10px;font-size:12px;color:#555;margin-bottom:16px;">
                ...
                <label for="terms">
                    I agree to the
                    <a href="<?php echo e(route('terms')); ?>" target="_blank" style="color:#1a3a6c;font-weight:600;">Terms & Conditions</a>
                    and
    ...
    <div class="switch-text" style="margin-top:8px;">
        ...
        <a href="<?php echo e(route('admission')); ?>">Apply for Admission</a>
    </div>
...
</html><?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views\register.blade.php ENDPATH**/ ?>