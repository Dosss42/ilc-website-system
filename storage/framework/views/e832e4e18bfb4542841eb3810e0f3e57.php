...
<head>
<meta charset="UTF-8">
<title>SF10 - <?php echo e($student->name); ?></title>
<style>
...
<div class="page">
    ...
    <div class="sf-header">
        <div class="sf-header-logo">
            <?php if($schoolLogoBase64): ?>
                <img src="<?php echo e($schoolLogoBase64); ?>" alt="School Logo" style="width:55px;height:55px;object-fit:contain;">
            <?php else: ?>
        ...
        <div class="sf-header-center">
            ...
            <div class="school-addr"><?php echo e($schoolAddress); ?></div>
        </div>
        <div class="sf-header-deped">
            <?php if($depedLogoBase64): ?>
                <img src="<?php echo e($depedLogoBase64); ?>" alt="DepEd Logo" style="width:55px;height:55px;object-fit:contain;">
            <?php else: ?>
    ...
    <table class="info-tbl">
        <tr>
            ...
            <td style="width:55%"><span class="lbl">School Name</span><span class="val"><?php echo e($schoolName); ?></span></td>
            <td style="width:23%"><span class="lbl">School Year</span><span class="val"><?php echo e($schoolYear); ?></span></td>
        </tr>
        <tr>
            <td colspan="2"><span class="lbl">School Address</span><span class="val"><?php echo e($schoolAddress); ?></span></td>
    ...
    <table class="info-tbl">
        <tr>
            <td style="width:30%"><span class="lbl">Learner Reference Number (LRN)</span><span class="val"><?php echo e($student->lrn ?: '—'); ?></span></td>
            <td style="width:70%" colspan="3">
                <span class="lbl">Name (Last Name, First Name, Middle Name)</span>
                <span class="val"><?php echo e(strtoupper($lastName)); ?>, <?php echo e(strtoupper($firstName)); ?> <?php echo e(strtoupper($middleName)); ?><?php echo e($suffix ? ' '.$suffix : ''); ?></span>
            </td>
        </tr>
        <tr>
            <td><span class="lbl">Date of Birth (mm/dd/yyyy)</span><span class="val"><?php echo e($birthdate); ?></span></td>
            <td><span class="lbl">Place of Birth</span><span class="val"><?php echo e($placeOfBirth ?: '—'); ?></span></td>
            <td><span class="lbl">Sex</span><span class="val"><?php echo e(ucfirst($gender)); ?></span></td>
            <td><span class="lbl">Mother Tongue</span><span class="val"><?php echo e($motherTongue); ?></span></td>
        </tr>
    </table>
    ...
    <table class="info-tbl" style="margin-top:2px;">
        ...
        <tr>
            <td style="width:30%"><span class="lbl">House No. / Street</span><span class="val"><?php echo e($streetAddress ?: '—'); ?></span></td>
            <td style="width:25%"><span class="lbl">Barangay</span><span class="val"><?php echo e($barangay ?: '—'); ?></span></td>
            <td style="width:25%"><span class="lbl">Municipality / City</span><span class="val"><?php echo e($city ?: '—'); ?></span></td>
            <td style="width:20%"><span class="lbl">Province</span><span class="val"><?php echo e($province ?: '—'); ?></span></td>
        </tr>
    </table>
    ...
    <table class="info-tbl" style="margin-top:2px;">
        <tr>
            <td style="width:33%"><span class="lbl">Name of Mother (Last, First, Middle)</span><span class="val"><?php echo e($motherName ?: '—'); ?></span></td>
            <td style="width:33%"><span class="lbl">Name of Father (Last, First, Middle)</span><span class="val"><?php echo e($fatherName ?: '—'); ?></span></td>
            <td style="width:34%"><span class="lbl">Guardian's Name (if not parent)</span><span class="val"><?php echo e($guardianName ?: '—'); ?></span></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>
                <span class="lbl">Relationship to Learner</span><span class="val"><?php echo e($guardianRelation ?: '—'); ?></span>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <span class="lbl">Contact Number (of Mother / Father / Guardian)</span>
                <span class="val"><?php echo e($guardianPhone ?: '—'); ?></span>
            </td>
            <td>
                <span class="lbl">Religious Affiliation</span>
                <span class="val"><?php echo e($religiousAffiliation ?: '—'); ?></span>
            </td>
        </tr>
    </table>
    ...
    <table class="info-tbl" style="margin-top:2px;">
        <tr>
            <td style="width:20%"><span class="lbl">Blood Type</span><span class="val"><?php echo e($bloodType ?: '—'); ?></span></td>
            <td style="width:40%"><span class="lbl">Allergies / Special Medical Conditions</span><span class="val"><?php echo e($allergies ?: 'None'); ?></span></td>
            <td style="width:40%"><span class="lbl">Last School Attended (for transferees)</span><span class="val"><?php echo e($lastSchool ?: '—'); ?></span></td>
        </tr>
    </table>
    ...
    <?php else: ?>
        <?php $__currentLoopData = $enrollments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $enr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="grade-tbl">
                <thead>
                    <tr>
                        <th colspan="<?php echo e(3 + $termCount); ?>" style="text-align:left; font-size:10px; background:#001f5e;">
                            <?php echo e($grDisplay); ?> &nbsp;|&nbsp; Section: <?php echo e($enr->section ?? '—'); ?> &nbsp;|&nbsp; S.Y. <?php echo e($enr->school_year); ?> &nbsp;|&nbsp; Status: <?php echo e(ucfirst($enr->status)); ?>
                    ...
                    <tr>
                        ...
                        <?php for($t = 1; $t <= $termCount; $t++): ?>
                            <th><?php echo e($t); ?><?php echo e($t==1?'st':($t==2?'nd':'rd')); ?> Term</th>
                        <?php endfor; ?>
                        <th>Final Rating</th>
                        <th>Remarks</th>
                    </tr>
                ...
                <tbody>
                    <?php $rowNum = 0; $passCount = 0; $failCount = 0; $totalFinal = 0; $gradeCount = 0; ?>
                    <?php $__empty_1 = true; $__currentLoopData = $enr->subjects ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $rowNum++;
                        ...
                        <tr>
                            ...
                            <td class="subj"><?php echo e($subj->name); ?></td>
                            <?php for($t = 1; $t <= $termCount; $t++): ?>
                                <?php $tg = $termGrades[$t]; ?>
                                <td>
                                    <?php if($tg): ?>
                                        <?php if($isDescriptive && $tg->descriptive_grade): ?>
                                            <span class="grade-desc"><?php echo e($tg->descriptive_grade); ?></span>
                                        <?php elseif($tg->grade !== null): ?>
                                            <span class="<?php echo e($tg->grade >= 75 ? 'grade-pass' : 'grade-fail'); ?>"><?php echo e(number_format($tg->grade, 0)); ?></span>
                                        <?php else: ?>
                            ...
                            <?php endfor; ?>
                            <td>
                                <?php if($finalRating !== null): ?>
                                    <strong class="<?php echo e($finalRating >= 75 ? 'grade-pass' : 'grade-fail'); ?>"><?php echo e(number_format($finalRating, 0)); ?></strong>
                                <?php else: ?>
                                    —
                                <?php endif; ?>
                            </td>
                            <td>
                                <?php if($remarks): ?>
                                    <span class="<?php echo e($remarks === 'Passed' ? 'grade-pass' : 'grade-fail'); ?>"><?php echo e($remarks); ?></span>
                                <?php else: ?> —
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="<?php echo e(3 + $termCount); ?>" style="text-align:center; color:#999; padding:6px;">No subjects on record.</td></tr>
                    <?php endif; ?>

                    <?php if($gradeCount > 0): ?>
                    <tr class="avg-row">
                        <td colspan="2" style="text-align:right;">General Average</td>
                        <?php for($t = 1; $t <= $termCount; $t++): ?><td>—</td><?php endfor; ?>
                        <td><strong><?php echo e(number_format($totalFinal / $gradeCount, 2)); ?></strong></td>
                        <td><span class="<?php echo e(($totalFinal/$gradeCount) >= 75 ? 'grade-pass' : 'grade-fail'); ?>"><?php echo e(($totalFinal/$gradeCount) >= 75 ? 'Promoted' : 'Retained'); ?></span></td>
                    </tr>
                    <?php endif; ?>
                </tbody>
            </table>
    ...
    <div class="sig-block">
        <div class="sig-cell">
            <div class="sig-line"><?php echo e($student->name); ?></div>
            <div class="sig-sub">Learner / Parent / Guardian Signature over Printed Name</div>
        </div>
        <div class="sig-cell">
            <div class="sig-line"><?php echo e($principalName ?: '______________________________'); ?></div>
            <div class="sig-sub">School Principal / Head Teacher</div>
        </div>
        <div class="sig-cell">
            <div style="font-size:9px; text-align:right; color:#555;">Date Printed: <?php echo e(now()->format('F d, Y')); ?></div>
    ...
    <div class="footer-note">
        This document is an official record of <?php echo e($schoolName); ?>. Unauthorized alteration of this form is punishable by law.
        &nbsp;|&nbsp; SF10 – Learner's Permanent Academic Record &nbsp;|&nbsp; <?php echo e($schoolYear); ?>
