...
<head>
    ...
    <title>ILC Enrollment Verification Code</title>
</head>
            ...
            <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08);">
                ...
                <tr>
                    <td style="background:linear-gradient(135deg,#1a3a6c,#2471a3);padding:32px 40px;text-align:center;">
                        ...
                        <div style="font-size:13px;color:rgba(255,255,255,.7);margin-top:4px;">General Tinio, Nueva Ecija</div>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding:40px;">
                        <div style="font-size:15px;color:#374151;margin-bottom:8px;">Hello,</div>
                        <div style="font-size:15px;color:#374151;margin-bottom:24px;line-height:1.6;">
                            You requested to verify your email address <strong><?php echo e($email); ?></strong> for your
                            enrollment application at IEMELIF Learning Center.<br><br>
                            Use the verification code below to complete your application:
                        </div>
                        ...
                        <div style="background:#f0f7ff;border:2px dashed #2471a3;border-radius:12px;padding:28px;text-align:center;margin-bottom:28px;">
                            ...
                            <div style="font-size:12px;color:#94a3b8;margin-top:12px;">This code expires in <strong>3 minutes</strong></div>
                        </div>
                        ...
                        <div style="background:#fff8f0;border:1px solid #fed7aa;border-radius:8px;padding:14px 16px;margin-bottom:24px;">
                            <div style="font-size:13px;color:#92400e;display:flex;align-items:flex-start;gap:8px;">
                                ...
                                <span><strong>Do not share this code</strong> with anyone. ILC staff will never ask for your verification code.</span>
                            </div>
                        </div>

                        <div style="font-size:13px;color:#94a3b8;line-height:1.6;">
                            If you did not request this code, please ignore this email. No enrollment will be created.
                        </div>
                    </td>
                </tr>
...
<?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views/emails/enrollment-otp.blade.php ENDPATH**/ ?>