        ...
        <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:20px;flex-wrap:wrap;gap:14px;">
            ...
            <div style="display:flex;gap:10px;">
                ...
                <div style="background:#fff;border:1.5px solid #e2e8f0;border-radius:12px;padding:10px 16px;text-align:center;min-width:100px;box-shadow:0 2px 8px rgba(0,0,0,.04);">
                    ...
                    <div style="font-size:13px;font-weight:800;color:#1e293b;margin:4px 0;"><?php echo e(auth('cashier')->user()->name ?? 'Staff'); ?></div>
                    ...
                    <div style="padding:14px 16px 16px;">
                        ...
                        <div id="onlineMethodRow" style="display:none;margin-top:14px;">
                            ...
                            <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;">
                                <?php $__currentLoopData = [['gcash','bi-phone-fill','#0070ff','GCash'],['maya','bi-wallet2','#00b09b','Maya'],['grabpay','bi-bag-fill','#00b14f','Grab'],['bank','bi-bank2','#1a3a6c','Bank'],['otc','bi-shop','#e65100','OTC']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$m,$icon,$color,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="card-box">
            <div class="card-box-header">
                <div style="display:flex;gap:10px;flex-wrap:wrap;align-items:center;width:100%;">
                    <input type="date" class="form-fld" style="max-width:150px;" value="<?php echo e(date('Y-m-d')); ?>">
            ...
            <div style="overflow-x:auto;">
                <table class="data-table">
                    ...
                    <tbody id="historyTbody">
                        <?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td style="color:#94a3b8;"><?php echo e($i + 1); ?></td>
                            <td><span style="font-family:monospace;font-size:11.5px;background:#f8faff;padding:3px 8px;border-radius:6px;color:#475569;"><?php echo e($tx->reference_number ?? '—'); ?></span></td>
                            <td>
                                <div style="font-weight:700;color:#1e293b;"><?php echo e($tx->user?->name ?? '—'); ?></div>
                                <div style="font-size:11px;color:#94a3b8;"><?php echo e($tx->enrollment?->grade_level ? ucfirst($tx->enrollment->grade_level) : '—'); ?></div>
                            </td>
                            <td><?php echo e($tx->enrollment?->grade_level ? ucfirst($tx->enrollment->grade_level) : '—'); ?></td>
                            <td style="font-size:12px;"><?php echo e(ucwords(str_replace('_',' ',$tx->payment_type ?? '—'))); ?></td>
                            <td>
                                <?php if(in_array($tx->payment_method,['cash','Cash'])): ?>
                                    <span class="method-pill cash"><i class="bi bi-cash"></i> Cash</span>
                                <?php else: ?>
                                    <span class="method-pill gcash"><i class="bi bi-phone"></i> <?php echo e(ucfirst($tx->payment_method ?? '—')); ?></span>
                                <?php endif; ?>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge-status rejected"><?php echo e(ucfirst($tx->status)); ?></span>
                                <?php endif; ?>
                            </td>
                            <td style="font-size:12px;color:#64748b;"><?php echo e($tx->processed_at?->format('M d, Y')); ?><br><span style="font-size:10px;"><?php echo e($tx->processed_at?->format('h:i A')); ?></span></td>
                            <td>
                                <button onclick="reprintTx('<?php echo e($tx->reference_number); ?>','<?php echo e($tx->user?->name); ?>','<?php echo e($tx->enrollment?->grade_level); ?>','<?php echo e($tx->enrollment?->school_year); ?>','<?php echo e($tx->payment_type); ?>','<?php echo e($tx->payment_method); ?>','<?php echo e($tx->amount); ?>','<?php echo e($tx->processed_at?->format('M d, Y')); ?>','<?php echo e($tx->processed_at?->format('h:i A')); ?>')"
