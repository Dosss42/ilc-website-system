    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="details">
                ...
                <p><strong>Student Name:</strong> <?php echo e($studentName); ?></p>
                <p><strong>Reference Number:</strong> <?php echo e($referenceNumber); ?></p>
                <p><strong>Grade Level:</strong> <?php echo e($gradeLevel); ?></p>
            </div>
            ...
            <div class="info-box">
                ...
                <p><strong>Phone:</strong> <?php echo e($contactPhone); ?></p>
                <p><strong>Email:</strong> <?php echo e($contactEmail); ?></p>
...
<?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views\emails\enrollment-declined.blade.php ENDPATH**/ ?>