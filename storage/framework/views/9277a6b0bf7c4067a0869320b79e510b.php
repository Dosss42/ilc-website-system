    ...
    <div class="container">
        ...
        <div style="text-align: center; margin-bottom: 40px; padding-bottom: 20px; border-bottom: 2px solid #e2e8f0;">
            <div style="display: flex; justify-content: center; gap: 15px; margin-bottom: 15px;">
                <img src="<?php echo e(asset('images/logo1.png')); ?>" alt="ILC Logo" style="height: 80px; width: auto;">
                <img src="<?php echo e(asset('images/logoo.jpg')); ?>" alt="ILC Logo" style="height: 80px; width: auto;">
            </div>
        ...
        <div class="highlight">
            <strong>Last Updated:</strong> <?php echo e(now()->format('F j, Y')); ?><br>
            <strong>Effective Date:</strong> <?php echo e(now()->format('F j, Y')); ?>
        ...
        <p class="last-updated">
            <strong>Immaculate Learning Center</strong><br>
            These Terms and Conditions were last updated on <?php echo e(now()->format('F j, Y')); ?>.
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views/terms_and_conditions.blade.php ENDPATH**/ ?>