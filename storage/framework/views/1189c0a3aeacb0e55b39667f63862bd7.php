...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>This is a friendly reminder that your tuition payment for <strong><?php echo e($installment->month_name); ?></strong> is now overdue.</p>
            ...
            <div class="details">
                ...
                <p><strong>Due Date:</strong> <?php echo e($dueDate); ?></p>
                <p><strong>Amount Due:</strong> <span class="amount">₱<?php echo e($amount); ?></span></p>
                <?php if($enrollment->grade_level): ?>
            ...
            <p><a href="<?php echo e(route('student.portal')); ?>" style="background: #1a3a6c; color: white; padding: 12px 24px; text-decoration: none; display: inline-block; border-radius: 4px;">Access Student Portal</a></p>
        </div>
...
<?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views\emails\payment-reminder.blade.php ENDPATH**/ ?>