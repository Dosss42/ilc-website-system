...
<div class="auth-wrapperr">
    <div class="auth-card">
        ...
        <div class="progress-section">
            ...
            <div class="progress">
                <div class="progress-bar" id="overallProgress" role="progressbar" style="width: <?php echo e(round($percentage)); ?>%"></div>
            </div>
        </div>
        ...
        <div class="section-list">
            ...
            <div class="section-row">
                <div class="row-icon <?php echo e($completion[$sec['key']] ? 'complete' : 'incomplete'); ?>">
                    <i class="bi <?php echo e($completion[$sec['key']] ? 'bi-check-lg' : $sec['icon']); ?>"></i>
                </div>
                <div class="row-info">
                    <h6><?php echo e($sec['title']); ?></h6>
                </div>
                <span id="<?php echo e($sec['id']); ?>" class="status-badge <?php echo e($completion[$sec['key']] ? 'status-complete' : 'status-incomplete'); ?>">
                    <?php echo e($completion[$sec['key']] ? 'Complete' : 'Incomplete'); ?>

                </span>
                <button class="btn-complete" onclick="toggleSection('<?php echo e($sec['key']); ?>')">
                    <?php echo e($sec['key'] === 'payment' ? 'View' : ($completion[$sec['key']] ? 'Edit' : 'Complete')); ?>
                ...
                <div class="row g-2 mb-2">
                    <div class="col-3">
                        ...
                        <input type="text" name="first_name" class="form-control" placeholder="Juan"
                               value="<?php echo e($profile->first_name ?? $d['first_name'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Middle Name</label>
                        <input type="text" name="middle_name" class="form-control" placeholder="Santos"
                               value="<?php echo e($profile->middle_name ?? $d['middle_name'] ?? ''); ?>" oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Last Name *</label>
                        <input type="text" name="last_name" class="form-control" placeholder="Cruz"
                               value="<?php echo e($profile->last_name ?? $d['last_name'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Suffix</label>
                        <select name="suffix" class="form-control">
                            <option value="">None</option>
                            <option value="Jr." <?php echo e(($profile->suffix ?? '') === 'Jr.' ? 'selected' : ''); ?>>Jr.</option>
                            <option value="Sr." <?php echo e(($profile->suffix ?? '') === 'Sr.' ? 'selected' : ''); ?>>Sr.</option>
                            <option value="II" <?php echo e(($profile->suffix ?? '') === 'II' ? 'selected' : ''); ?>>II</option>
                            <option value="III" <?php echo e(($profile->suffix ?? '') === 'III' ? 'selected' : ''); ?>>III</option>
                        </select>
                    </div>
                </div>
                <div class="row g-2 mb-2">
                    <div class="col-3">
                        ...
                        <input type="date" name="birthdate" class="form-control" 
                               value="<?php echo e($profile->birthdate ?? $d['birthdate'] ?? ''); ?>" required max="<?php echo e(date('Y-m-d')); ?>">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Gender *</label>
                        <select name="gender" class="form-control" required>
                            <option value="" disabled>Select Gender</option>
                            <?php $gen = $profile->gender ?? $d['gender'] ?? ''; ?>
                            <option value="male" <?php echo e($gen === 'male' ? 'selected' : ''); ?>>Male</option>
                            <option value="female" <?php echo e($gen === 'female' ? 'selected' : ''); ?>>Female</option>
                        </select>
                    </div>
                    <div class="col-3">
                        <label class="form-label">Place of Birth *</label>
                        <input type="text" name="place_of_birth" class="form-control" placeholder="General Tinio, Nueva Ecija"
                               value="<?php echo e($profile->place_of_birth ?? $d['place_of_birth'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Nationality *</label>
                        <input type="text" name="nationality" class="form-control" placeholder="Filipino"
                               value="<?php echo e($profile->nationality ?? $d['nationality'] ?? 'Filipino'); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        ...
                        <input type="text" name="mother_name" class="form-control" placeholder="Mother's full name"
                               value="<?php echo e($mother?->name ?? $d['mother_name'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Mother's Age *</label>
                        <input type="number" name="mother_age" class="form-control" placeholder="Age"
                               value="<?php echo e($mother?->age ?? $d['mother_age'] ?? ''); ?>" required min="1" max="120">
                    </div>
                    <div class="col-3">
                        ...
                        <input type="text" name="religious_affiliation" class="form-control" placeholder="e.g., Roman Catholic"
                               value="<?php echo e($profile->religious_affiliation ?? $d['religious_affiliation'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" name="father_name" class="form-control" placeholder="Father's full name"
                               value="<?php echo e($father?->name ?? $d['father_name'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Father's Age *</label>
                        <input type="number" name="father_age" class="form-control" placeholder="Age"
                               value="<?php echo e($father?->age ?? $d['father_age'] ?? ''); ?>" required min="1" max="120">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Contact Number</label>
                        <input type="text" name="contact" class="form-control" placeholder="09XX-XXX-XXXX"
                               value="<?php echo e($profile->contact ?? $d['guardian_phone'] ?? ''); ?>">
                    </div>
                </div>
                ...
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        ...
                        <select name="blood_type" class="form-control">
                            ...
                            <?php $bt = $profile->blood_type ?? $d['blood_type'] ?? ''; ?>
                            <option value="A+" <?php echo e($bt === 'A+' ? 'selected' : ''); ?>>A+</option>
                            <option value="A-" <?php echo e($bt === 'A-' ? 'selected' : ''); ?>>A-</option>
                            <option value="B+" <?php echo e($bt === 'B+' ? 'selected' : ''); ?>>B+</option>
                            <option value="B-" <?php echo e($bt === 'B-' ? 'selected' : ''); ?>>B-</option>
                            <option value="O+" <?php echo e($bt === 'O+' ? 'selected' : ''); ?>>O+</option>
                            <option value="O-" <?php echo e($bt === 'O-' ? 'selected' : ''); ?>>O-</option>
                            <option value="AB+" <?php echo e($bt === 'AB+' ? 'selected' : ''); ?>>AB+</option>
                            <option value="AB-" <?php echo e($bt === 'AB-' ? 'selected' : ''); ?>>AB-</option>
                            <option value="unknown" <?php echo e($bt === 'unknown' ? 'selected' : ''); ?>>Unknown</option>
                        </select>
                    </div>
                    <div class="col-6">
                        <label class="form-label">Allergies</label>
                        <input type="text" name="allergies" class="form-control" placeholder="List any known allergies"
                               value="<?php echo e($profile->allergies ?? $d['allergies'] ?? ''); ?>" oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="row g-2 mb-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="medical_conditions" class="form-control" placeholder="Any chronic conditions or medications"
                               value="<?php echo e($profile->medical_conditions ?? $d['medical_conditions'] ?? ''); ?>" oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="d-flex gap-2">
                ...
                <div class="row g-2 mb-2">
                    <div class="col-3">
                        ...
                        <input type="text" name="province" class="form-control" placeholder="Province"
                               value="<?php echo e($address->province ?? $d['province'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">City / Municipality *</label>
                        <input type="text" name="city" class="form-control" placeholder="City/Municipality"
                               value="<?php echo e($address->city ?? $address->municipality ?? $d['city'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Barangay *</label>
                        <input type="text" name="barangay" class="form-control" placeholder="Barangay"
                               value="<?php echo e($address->barangay ?? $d['barangay'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        ...
                        <input type="text" name="street_address" class="form-control" placeholder="House No., Street, Purok"
                               value="<?php echo e($address->street_address ?? $d['street_address'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        ...
                        <input type="text" name="zip_code" class="form-control" placeholder="3100"
                               value="<?php echo e($address->zip_code ?? $d['zip_code'] ?? ''); ?>">
                    </div>
                </div>
                <div class="d-flex gap-2">
                ...
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        ...
                        <input type="text" name="guardian_name" class="form-control" placeholder="Full name of parent/guardian"
                               value="<?php echo e($guardian->name ?? $d['guardian_name'] ?? ''); ?>" required oninput="capitalizeFirst(this)">
                    </div>
                    <div class="col-3">
                        <label class="form-label">Relationship *</label>
                        <select name="relationship" class="form-control" required>
                            <option value="" disabled selected>Select Type</option>
                            <?php $rel = strtolower($guardian->relationship ?? $d['relationship'] ?? ''); ?>
                            <option value="father" <?php echo e($rel === 'father' ? 'selected' : ''); ?>>Father</option>
                            <option value="mother" <?php echo e($rel === 'mother' ? 'selected' : ''); ?>>Mother</option>
                            <option value="guardian" <?php echo e($rel === 'guardian' ? 'selected' : ''); ?>>Guardian</option>
                            <option value="sibling" <?php echo e($rel === 'sibling' ? 'selected' : ''); ?>>Sibling</option>
                            <option value="grandparent" <?php echo e($rel === 'grandparent' ? 'selected' : ''); ?>>Grandparent</option>
                            <option value="relative" <?php echo e($rel === 'relative' ? 'selected' : ''); ?>>Relative</option>
                        </select>
                    </div>
                    <div class="col-3">
                        <label class="form-label">Occupation</label>
                        <input type="text" name="guardian_occupation" class="form-control" placeholder="Job title or profession"
                               value="<?php echo e($guardian->occupation ?? $d['guardian_occupation'] ?? ''); ?>" oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        ...
                        <input type="tel" name="guardian_phone" class="form-control" placeholder="09XX-XXX-XXXX"
                               ...
                               value="<?php echo e($guardian->contact ?? $d['guardian_phone'] ?? ''); ?>" required>
                    </div>
                </div>
                <div class="row g-2 mb-3">
                    <div class="col-6">
                        ...
                        <input type="email" name="student_email" class="form-control" placeholder="This will be used to create your student login"
                               value="<?php echo e($profile->student_email ?? $d['student_email'] ?? ''); ?>" required>
                    </div>
                    <div class="col-6">
        ...
        <div id="school-form" class="form-section mt-4">
            ...
            <form method="POST" action="<?php echo e(route('profile.school.update')); ?>">
                <?php echo csrf_field(); ?>
                <div class="mb-2">
                    <label class="form-label">School Name</label>
                    <input type="text" name="school_name" class="form-control" 
                           value="<?php echo e($previousSchool->school_name ?? $d['last_school'] ?? ''); ?>" required>
                </div>
                <div class="mb-2">
                    <label class="form-label">School Address</label>
                    <input type="text" name="school_address" class="form-control" 
                           value="<?php echo e($previousSchool->school_address ?? ''); ?>">
                </div>
                <div class="row g-2 mb-2">
                    <div class="col-6">
                        ...
                        <select name="last_grade_completed" class="form-control" required>
                            ...
                            <option value="Grade 1" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 1' ? 'selected' : ''); ?>>Grade 1</option>
                            <option value="Grade 2" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 2' ? 'selected' : ''); ?>>Grade 2</option>
                            <option value="Grade 3" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 3' ? 'selected' : ''); ?>>Grade 3</option>
                            <option value="Grade 4" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 4' ? 'selected' : ''); ?>>Grade 4</option>
                            <option value="Grade 5" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 5' ? 'selected' : ''); ?>>Grade 5</option>
                            <option value="Grade 6" <?php echo e(($previousSchool->last_grade_completed ?? '') === 'Grade 6' ? 'selected' : ''); ?>>Grade 6</option>
                        </select>
                    </div>
                    <div class="col-6">
                        <label class="form-label">School Year Graduated</label>
                        <input type="number" name="school_year_graduated" class="form-control" 
                               value="<?php echo e($previousSchool->school_year_graduated ?? ''); ?>" 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="general_average" class="form-control" 
                           value="<?php echo e($previousSchool->general_average ?? ''); ?>" 
        ...
        <div id="enrollment-form" class="form-section mt-4">
            ...
            <form method="POST" action="<?php echo e(route('profile.enrollment.update')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row g-2 mb-3">
                    <div class="col-4">
                        ...
                        <select name="grade_level" class="form-control" required>
                            ...
                            <?php $gl = $enrollment->grade_level ?? $d['grade_level'] ?? ''; ?>
                            <option value="nursery" <?php echo e($gl === 'nursery' ? 'selected' : ''); ?>>Nursery</option>
                            <option value="kindergarten" <?php echo e($gl === 'kindergarten' ? 'selected' : ''); ?>>Kindergarten</option>
                            <option value="grade1" <?php echo e($gl === 'grade1' ? 'selected' : ''); ?>>Grade 1</option>
                            <option value="grade2" <?php echo e($gl === 'grade2' ? 'selected' : ''); ?>>Grade 2</option>
                            <option value="grade3" <?php echo e($gl === 'grade3' ? 'selected' : ''); ?>>Grade 3</option>
                            <option value="grade4" <?php echo e($gl === 'grade4' ? 'selected' : ''); ?>>Grade 4</option>
                            <option value="grade5" <?php echo e($gl === 'grade5' ? 'selected' : ''); ?>>Grade 5</option>
                            <option value="grade6" <?php echo e($gl === 'grade6' ? 'selected' : ''); ?>>Grade 6</option>
                        </select>
                    </div>
                    <div class="col-4">
                        ...
                        <select name="student_type" class="form-control" required>
                            <option value="" disabled selected>Select Type</option>
                            <?php $st = $profile->student_type ?? $d['student_type'] ?? ''; ?>
                            <option value="new" <?php echo e($st === 'new' ? 'selected' : ''); ?>>New Student</option>
                            <option value="transferee" <?php echo e($st === 'transferee' ? 'selected' : ''); ?>>Transferee</option>
                            <option value="returning" <?php echo e($st === 'returning' ? 'selected' : ''); ?>>Returning Student</option>
                        </select>
                    </div>
                    <div class="col-4">
                        ...
                        <input type="text" name="last_school" class="form-control" placeholder="School Name"
                               value="<?php echo e($profile->last_school ?? $d['last_school'] ?? ''); ?>" oninput="capitalizeFirst(this)">
                    </div>
                </div>
                <div class="d-flex gap-2">
            ...
            <div style="background:#f0f4ff; border-radius:10px; padding:16px; margin-bottom:12px;">
                <div class="row text-center">
                    <div class="col-4">
                        ...
                        <div style="font-size:20px; font-weight:700; color:var(--primary-color);">₱<?php echo e(number_format($totalFee, 2)); ?></div>
                    </div>
                    <div class="col-4">
                        <div style="font-size:11px; color:#6c757d; text-transform:uppercase; letter-spacing:0.5px;">Paid</div>
                        <div style="font-size:20px; font-weight:700; color:#28a745;">₱<?php echo e(number_format($paidAmt, 2)); ?></div>
                    </div>
                    <div class="col-4">
                        <div style="font-size:11px; color:#6c757d; text-transform:uppercase; letter-spacing:0.5px;">Balance</div>
                        <div style="font-size:20px; font-weight:700; color:<?php echo e($balance > 0 ? '#dc3545' : '#28a745'); ?>;">₱<?php echo e(number_format(max($balance, 0), 2)); ?></div>
                    </div>
                </div>
            </div>
            <div class="row g-2 mb-2">
                ...
                <div class="col-6">
                    ...
                    <div class="form-control" style="background:#e9ecef;">
                        <?php echo e(ucfirst($enrollment->payment_method ?? 'Not yet paid')); ?>

                    </div>
                </div>
            </div>
            <?php if($enrollment->payment_reference ?? false): ?>
            <div class="mb-2">
                <label class="form-label">Reference Number</label>
                <div class="form-control" style="background:#e9ecef;"><?php echo e($enrollment->payment_reference); ?></div>
            </div>
            <?php endif; ?>
        ...
        <div class="navigation-footer">
            <a href="<?php echo e(route('student.portal')); ?>" class="btn-outline-secondary">
...
<?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views\profile\complete.blade.php ENDPATH**/ ?>