...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/contact.css')); ?>?v=1780250000">  
    <style>
    ...
    <div style="padding:28px 0 48px;background:#fff;">
        <div class="container"><div class="row g-4">
            <div class="col-lg-7">
                ...
                <?php for($i=0;$i<4;$i++): ?><span class="skel" style="height:44px;width:100%;display:block;border-radius:8px;margin-bottom:11px;"></span><?php endfor; ?>
            ...
            <div class="col-lg-5">
                ...
                <?php for($i=0;$i<3;$i++): ?><span class="skel" style="height:56px;width:100%;display:block;border-radius:8px;margin-bottom:10px;"></span><?php endfor; ?>
            </div>
        </div></div>
    </div>
</div>
...
$message = $__bag->first($__errorArgs[0]); ?><div style="color:#dc2626;font-size:12px;margin-top:4px;"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <select name="subject" class="form-control <?php echo e($errors->has('subject') ? 'is-invalid' : ''); ?>" required>
                                    <option value="" disabled <?php echo e(old('subject') ? '' : 'selected'); ?>>Select a subject</option>
                                    <option value="Enrollment Inquiry" <?php echo e(old('subject') == 'Enrollment Inquiry' ? 'selected' : ''); ?>>Enrollment Inquiry</option>
                                    <option value="Academics"          <?php echo e(old('subject') == 'Academics'          ? 'selected' : ''); ?>>Academics</option>
                                    <option value="Finance / Tuition"  <?php echo e(old('subject') == 'Finance / Tuition'  ? 'selected' : ''); ?>>Finance / Tuition</option>
                                    <option value="Guidance & Counseling" <?php echo e(old('subject') == 'Guidance & Counseling' ? 'selected' : ''); ?>>Guidance &amp; Counseling</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" class="form-control <?php echo e($errors->has('message') ? 'is-invalid' : ''); ?>"
...
</html><?php /**PATH C:\Users\ron28\Desktop\ILC SYSTEM\ilc-website-system\resources\views\contact.blade.php ENDPATH**/ ?>