            ...
            <div class="col-md-4">
                ...
                <div style="display:flex;align-items:center;gap:10px;background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:10px 14px;margin-top:8px;">
                    ...
                    <div>
                        ...
                        <div style="font-size:20px;font-weight:800;color:#fff;line-height:1.2;">{{ number_format($visitorCount ?? (int)\App\Models\Setting::get('visitor_count', 0)) }}</div>
                    </div>
...
function ckShowAgain(e) {
    ...
    if (banner && overlay) {
        ...
        window.location.href = '{{ route("home") }}#cookie-settings';
    }
}
