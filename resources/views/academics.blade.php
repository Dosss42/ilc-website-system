    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('academics') }}">Academics</a></li>
...
{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     PAGE BANNER
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
{{-- â•â• SKELETON: content + footer â•â• --}}
...
<nav id="acad-quicknav">
    ...
    {{-- Calendar with click-toggle sub-links --}}
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                ...
                <div class="overview-text">
                    {{-- CHANGE: Update with your actual academic overview --}}
                    <p>
                ...
                {{-- Stat Badges --}}
                {{-- CHANGE: Update numbers to match your actual school data --}}
...
{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     SECTION 2: GRADE LEVELS
     4 cards &mdash; one per grade
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
            ...
            <div class="col-md-6 col-lg-3">
                <div class="grade-card">
                    ...
                    <div class="grade-card-body">
                        {{-- CHANGE: Update subjects per grade as needed --}}
...
<section class="subjects-section">
    <div class="container">
        ...
        <h2 class="acad-section-title center">Subject Areas</h2>
        <p class="acad-section-subtitle center">All subjects are taught in alignment with the DepEd curriculum framework.</p>

        <div class="row g-3">

            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    <div class="cat-icon"><i class="bi bi-translate"></i></div>
                    <h5>Languages</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> English (Reading, Writing, Speaking)</li>
                        <li><i class="bi bi-dot"></i> Filipino (Panitikan, Gramatika)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    <div class="cat-icon"><i class="bi bi-calculator-fill"></i></div>
                    <h5>Mathematics</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> Algebra & Geometry (Gr. 7&ndash;8)</li>
                        <li><i class="bi bi-dot"></i> Advanced Algebra (Gr. 9)</li>
                        <li><i class="bi bi-dot"></i> Pre-Calculus & Statistics (Gr. 10)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    <div class="cat-icon"><i class="bi bi-lightning-fill"></i></div>
                    <h5>Science</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> Earth & Life Science (Gr. 7)</li>
                        <li><i class="bi bi-dot"></i> Force & Motion, Biology (Gr. 8)</li>
                        <li><i class="bi bi-dot"></i> Chemistry & Physics (Gr. 9&ndash;10)</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    <div class="cat-icon"><i class="bi bi-globe-asia-australia"></i></div>
                    <h5>Social Studies</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> Araling Panlipunan (Gr. 7&ndash;10)</li>
                        <li><i class="bi bi-dot"></i> Philippine History & Culture</li>
                        <li><i class="bi bi-dot"></i> World History & Geography</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    ...
                    <h5>MAPEH</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> Music & Arts</li>
                        <li><i class="bi bi-dot"></i> Physical Education</li>
                        <li><i class="bi bi-dot"></i> Health Education</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-4 col-lg-4">
                <div class="subject-category-card">
                    ...
                    <h5>Values &amp; Faith</h5>
                    <ul>
                        <li><i class="bi bi-dot"></i> Christian Living Education</li>
                        <li><i class="bi bi-dot"></i> Bible Studies</li>
                        <li><i class="bi bi-dot"></i> Character Formation</li>
                    </ul>
                </div>
            </div>
...
<section class="calendar-section" id="sec-calendar">
    <div class="container">
        ...
        {{-- =============================================
             CHANGE: Update dates to match your actual
             school calendar for the current school year
             ============================================= --}}
            ...
            <table class="calendar-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><span class="event-badge school">School</span></td>
                        <td>All grade levels</td>
                    </tr>
                    <tr>
                        <td>June 12, 2026</td>
                        <td>Independence Day</td>
                        <td><span class="event-badge holiday">Holiday</span></td>
                        <td>No classes</td>
                    </tr>
                    <tr>
                        <td>July 4, 2026</td>
                        <td>1st Quarter Periodical Exam</td>
                        <td><span class="event-badge exam">Exam</span></td>
                        <td>All grade levels</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>ILC Founding Anniversary</td>
                        <td><span class="event-badge event">Event</span></td>
                        <td>School-wide celebration</td>
                    </tr>
                    <tr>
                        <td>October 2026</td>
                        <td>2nd Quarter Periodical Exam</td>
                        <td><span class="event-badge exam">Exam</span></td>
                        <td>All grade levels</td>
                    </tr>
                    <tr>
                        ...
                        <td><span class="event-badge school">School</span></td>
                        <td>Card signing &mdash; 1st & 2nd quarter</td>
                    </tr>
                    <tr>
                        <td>November 1&ndash;2, 2026</td>
                        <td>All Saints & All Souls Day</td>
                        <td><span class="event-badge holiday">Holiday</span></td>
                        <td>No classes</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>January 2027</td>
                        <td>3rd Quarter Periodical Exam</td>
                        <td><span class="event-badge exam">Exam</span></td>
                        <td>All grade levels</td>
                    </tr>
                    <tr>
                        <td>February 2027</td>
                        <td>Science Education Affair</td>
                        <td><span class="event-badge event">Event</span></td>
                        <td>STEM Showcase</td>
                    </tr>
                    <tr>
                        <td>March 2027</td>
                        <td>4th Quarter Periodical Exam</td>
                        <td><span class="event-badge exam">Exam</span></td>
                        <td>All grade levels</td>
                    </tr>
                    <tr>
                        <td>March 2027</td>
                        <td>Recognition &amp; Moving Up Ceremony</td>
                        <td><span class="event-badge event">Event</span></td>
                        <td>Grade 10 Graduation</td>
                    </tr>
        ...
        <div style="border:1px solid #93c5fd;border-radius:12px;margin-bottom:28px;overflow:hidden;">
            ...
            <div style="overflow-x:auto;">
                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                    ...
                    @foreach($eoRows as $i=>$row)
                    @php [$bg,$tc,$label] = $typeMap[$row[2]]; @endphp
                    <tr style="background:{{ $i%2==0?'#fff':'#f0f9ff' }};border-bottom:1px solid #e0f2fe;">
                        <td style="padding:9px 14px;font-weight:600;color:#374151;white-space:nowrap;">{{ $row[0] }}</td>
                        <td style="padding:9px 14px;color:#374151;">{{ $row[1] }}</td>
                        <td style="padding:9px 14px;"><span style="background:{{ $bg }};color:{{ $tc }};font-size:11px;font-weight:700;padding:2px 8px;border-radius:20px;">{{ $label }}</span></td>
                    </tr>
                    @endforeach
                    </tbody>
                </table>
        ...
        <div id="sec-term1" style="border:1px solid #bfdbfe;border-radius:12px;margin-bottom:28px;overflow:hidden;">
            ...
            <div style="overflow-x:auto;">
                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                    ...
                    @foreach($t1Rows as $i=>$row)
                    @php [$bg,$tc,$label] = $typeMap[$row[3]]; @endphp
                    <tr style="background:{{ $i%2==0?'#fff':'#f8faff' }};border-bottom:1px solid #f0f4f8;">
                        <td style="padding:9px 14px;font-weight:700;color:#1e3a8a;white-space:nowrap;">{{ $row[0] }}</td>
                        <td style="padding:9px 14px;font-weight:600;color:#374151;white-space:nowrap;">{{ $row[1] }}</td>
        ...
        <div id="sec-term2" style="border:1px solid #7dd3fc;border-radius:12px;margin-bottom:28px;overflow:hidden;">
            ...
            <div style="overflow-x:auto;">
                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                    ...
                    @foreach($t2Rows as $i=>$row)
                    @php [$bg,$tc,$label] = $typeMap[$row[3]]; @endphp
                    <tr style="background:{{ $i%2==0?'#fff':'#f0f7ff' }};border-bottom:1px solid #e8f0fe;">
                        <td style="padding:9px 14px;font-weight:700;color:#1e3a8a;white-space:nowrap;">{{ $row[0] }}</td>
                        <td style="padding:9px 14px;font-weight:600;color:#374151;white-space:nowrap;">{{ $row[1] }}</td>
                        <td style="padding:9px 14px;color:#374151;">{{ $row[2] }}</td>
                        <td style="padding:9px 14px;"><span style="background:{{ $bg }};color:{{ $tc }};font-size:11px;font-weight:700;padding:2px 8px;border-radius:20px;">{{ $label }}</span></td>
        ...
        <div id="sec-term3" style="border:1px solid #93c5fd;border-radius:12px;margin-bottom:28px;overflow:hidden;">
            ...
            <div style="overflow-x:auto;">
                <table style="width:100%;border-collapse:collapse;font-size:13px;">
                    ...
                    @foreach($t3Rows as $i=>$row)
                    @php [$bg,$tc,$label] = $typeMap[$row[3]]; @endphp
                    <tr style="background:{{ $i%2==0?'#fff':'#f0f9ff' }};border-bottom:1px solid #e0f2fe;">
                        <td style="padding:9px 14px;font-weight:700;color:#0369a1;white-space:nowrap;">{{ $row[0] }}</td>
                        <td style="padding:9px 14px;font-weight:600;color:#374151;white-space:nowrap;">{{ $row[1] }}</td>
                        <td style="padding:9px 14px;color:#374151;">{{ $row[2] }}</td>
                        <td style="padding:9px 14px;"><span style="background:{{ $bg }};color:{{ $tc }};font-size:11px;font-weight:700;padding:2px 8px;border-radius:20px;">{{ $label }}</span></td>
                    </tr>
...
{{-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     ...
     Two-column: table left, note right
â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• --}}
<section class="grading-section" id="sec-grading">
    <div class="container">
        ...
        {{-- Kindergarten Descriptive Rating --}}
        ...
        {{-- Grades 1&ndash;6 Numerical Grading --}}
        <div>
            <h5 style="font-size:15px;font-weight:700;color:#1e3a8a;margin-bottom:12px;display:flex;align-items:center;gap:8px;">
...
{{-- React Component Island: Interactive Academics Content --}}
<section class="react-academics-section">
    <div class="container">
        {{-- <div id="academics-page-react"></div> --}}
    </div>
</section>
