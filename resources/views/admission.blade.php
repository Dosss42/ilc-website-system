...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/styles.css') }}?v=1780320000">
    <link rel="stylesheet" href="{{ asset('css/enrollment.css') }}?v=1780320000">
    <style>
...
body, div, h1, h2, h3, h4, h5, h6, p, span, a, li, td, th, button, input, select, textarea {
    ...
    <link rel="stylesheet" href="{{ asset('css/ilc-typography.css') }}?v=1780320000">
</head>
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                {{-- <div class="school-logo"><img src="/images/logo1.png" alt="Logo 1"></div> --}}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('admission') }}">Enrollment</a></li><li class="nav-item">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    <div style="background:#fff;border-radius:12px;padding:22px;border:1px solid #eee;">
                        ...
                        @for($j=0;$j<4;$j++)<span class="skel" style="height:11px;width:100%;display:block;border-radius:4px;margin-bottom:5px;"></span>@endfor
                    </div>
                </div>
                @endfor
            </div>
...
<section class="req-section">
    <div class="container">
        ...
        <div style="background:#e8f0fb; border:1px solid #b8d0f0; border-radius:8px; padding:16px 20px; display:flex; align-items:flex-start; gap:14px; margin-bottom:32px;">
            ...
            <div>
                ...
                <div style="font-size:12px; color:#555; line-height:1.6;">
                    {{-- CHANGE: Update enrollment schedule --}}
        ...
        {{-- Enroll Now Button / Closed Notice --}}
        @if(session('enrollment_closed') || (isset($enrollmentOpen) && !$enrollmentOpen))
        ...
        @else
        <div class="text-center mt-5 mb-4">
            <a href="{{ route('enrollment.form') }}" class="btn-apply-now">
...
{{-- React Vite Directive removed - page uses Bootstrap only --}}
