...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/about.css') }}?v=1780250000">  {{-- About page specific styles --}}
    <style>
    ...
    {{-- @vite(['resources/css/app.css', 'resources/js/react/about-page.jsx']) --}}
<style>
...
<div class="skel-section" id="skel-content">
    ...
    <div style="padding:50px 0;background:#fff;">
        <div class="container"><div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7">
                ...
                @for($i=0;$i<4;$i++)<span class="skel" style="height:12px;width:100%;display:block;border-radius:4px;margin-bottom:7px;"></span>@endfor
    ...
    <div style="padding:48px 0;background:#f6f8fb;">
        <div class="container">
            ...
            <div class="row g-4">@for($i=0;$i<3;$i++)
                <div class="col-md-4"><div style="background:#fff;border-radius:12px;padding:28px;text-align:center;">
                    ...
                    @for($j=0;$j<3;$j++)<span class="skel" style="height:11px;width:100%;display:block;border-radius:4px;margin-bottom:6px;"></span>@endfor
                </div></div>@endfor
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    @for($i=0;$i<5;$i++)<span class="skel" style="height:12px;width:100%;display:block;border-radius:4px;margin-bottom:7px;"></span>@endfor
                </div>
            </div>
        </div>
    </div>
</div>
{{-- â•â• REAL: main content â•â• --}}
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-7">
                <div class="history-text">
                    ...
                    {{-- =============================================
                         CHANGE: Replace with your actual school history
                         ============================================= --}}
                    <p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="vmg-card">
                    ...
                    <h4>Vision</h4>
                    {{-- CHANGE: Replace with your actual vision statement --}}
                    <p>
            ...
            <div class="col-md-4">
                <div class="vmg-card">
                    ...
                    <h4>Mission</h4>
                    {{-- CHANGE: Replace with your actual mission statement --}}
                    <p>
            ...
            <div class="col-md-4">
                <div class="vmg-card">
                    ...
                    <h4>Philosophy</h4>
                    {{-- CHANGE: Replace with your actual goals statement --}}
                    <p>
        ...
        <div class="row g-5 align-items-start">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="principal-photo-box">
                    ...
                    {{-- CHANGE: Principal's actual name --}}
                    <div class="principal-name">MRS. Teofila Guillermo</div>
                    {{-- CHANGE: Principal's actual position --}}
                    
                    {{-- React Component Island: Interactive About Content --}}
            ...
            <div class="col-lg-9 col-md-8">
                <div class="principal-message-box">
                    ...
                    {{-- =============================================
                         CHANGE: Replace with actual principal's message
                         ============================================= --}}
                    <p>
