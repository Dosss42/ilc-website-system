...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your tuition payment for <strong>{{ $installment->month_name }}</strong> remains unpaid after 2 weeks past the due date.</p>
            ...
            <div class="details">
                ...
                <p><strong>Original Amount:</strong> ₱{{ number_format($installment->amount, 2) }}</p>
                <p><strong>Late Fee:</strong> <span class="late-fee">+₱{{ $lateFee }}</span></p>
                <p><strong>New Total Due:</strong> <span class="amount">₱{{ $totalDue }}</span></p>
            </div>
            ...
            <p><a href="{{ route('student.portal') }}" style="background: #dc3545; color: white; padding: 12px 24px; text-decoration: none; display: inline-block; border-radius: 4px;">Pay Now - Access Portal</a></p>
        </div>
