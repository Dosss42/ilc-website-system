    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link active" href="{{ route('aims') }}">AIMS</a></li>
        ...
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-7">
                    ...
                    @for($i=0;$i<3;$i++)<span class="skel-dark" style="height:13px;width:100%;display:block;border-radius:4px;margin-bottom:8px;"></span>@endfor
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div style="background:#fff;border-radius:16px;padding:28px 24px;">
                        ...
                        @for($j=0;$j<4;$j++)<span class="skel" style="height:11px;width:100%;border-radius:4px;display:block;margin-bottom:7px;"></span>@endfor
                    </div>
                </div>
                @endfor
            </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    @for($i=0;$i<5;$i++)<span class="skel" style="height:50px;width:100%;border-radius:12px;display:block;margin-bottom:10px;"></span>@endfor
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="role-card">
                    ...
                    @foreach(['View grades per subject & term','Check class schedule','Track tuition balance & pay online','Upload required documents','View school announcements'] as $f)
                    <div class="role-feature"><i class="bi bi-check2"></i>{{ $f }}</div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="role-card">
                    ...
                    @foreach(['Enter & submit grades by term','Record daily attendance','Post section announcements','Schedule parent-teacher meetings','View assigned sections & subjects'] as $f)
                    <div class="role-feature"><i class="bi bi-check2"></i>{{ $f }}</div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="role-card">
                    ...
                    @foreach(['Approve & process enrollments','Manage sections & teachers','Review submitted documents','Oversee all student records','Generate school reports'] as $f)
                    <div class="role-feature"><i class="bi bi-check2"></i>{{ $f }}</div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="role-card">
                    ...
                    @foreach(['Record walk-in payments','Generate Xendit payment links','Approve GCash screenshots','Manage installment schedules','View collection reports & charts'] as $f)
                    <div class="role-feature"><i class="bi bi-check2"></i>{{ $f }}</div>
                    @endforeach
                </div>
            </div>
...
{{-- How to access + FAQ side by side --}}
